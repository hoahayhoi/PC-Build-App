...
namespace api.Migrations
{
    ...
    [Migration("20241125025436_AddImageComponentConfiguration")]
    partial class AddImageComponentConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "808fccb6-71ac-48cf-a94d-1d9192d8ba40",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "e2286239-cb9a-430e-a1a5-7f1dfc65b811",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "658de90f-0650-4130-bc9f-d01273814dab",
                            Name = "SalesStaff",
                            NormalizedName = "SALESSTAFF"
                        },
                        new
                        {
                            Id = "131753e5-ddd6-4248-bfbc-7cc35babf8d2",
                            Name = "Technician",
            ...
            modelBuilder.Entity("api.Models.Order", b =>
                {
                    ...
                    b.HasOne("api.Models.AppUser", "SalesStaff")
                        .WithMany("OrdersSalesStaff")
                        .HasForeignKey("SalesStaffID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("api.Models.AppUser", "Technician")
                        .WithMany("OrdersTechnician")
            ...
            modelBuilder.Entity("api.Models.AppUser", b =>
                {
                    b.Navigation("OrdersSalesStaff");

                    b.Navigation("OrdersTechnician");
                });
