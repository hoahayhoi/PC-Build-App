// View/frm_QuanLyKho.Designer.cs
namespace PcBuiApp_Client_v1.View
{
    partial class frm_QuanLyKho
    {
        ...
        private void InitializeComponent()
        {
            ...
            Column_Ten = new DataGridViewTextBoxColumn();
            Column_DanhMuc = new DataGridViewTextBoxColumn();
            Column_Gia = new DataGridViewTextBoxColumn();
            Column_SoLuong = new DataGridViewTextBoxColumn();
            Column_Delete = new DataGridViewButtonColumn();
            panelMain = new Panel();
            ...
            panelActions.Location = new Point(408, 80);
            ...
            dataGridViewProducts.Columns.AddRange(new DataGridViewColumn[] { Column_STT, Column_Ten, Column_DanhMuc, Column_Gia, Column_SoLuong, Column_Delete });
            ...
            dataGridViewProducts.Size = new Size(1222, 686);
            ...
            // Column_Ten
            // 
            Column_Ten.HeaderText = "Tên Sản Phẩm";
            Column_Ten.Name = "Column_Ten";
            Column_Ten.ReadOnly = true;
            // 
            // Column_DanhMuc
            // 
            Column_DanhMuc.HeaderText = "Danh Mục";
            Column_DanhMuc.Name = "Column_DanhMuc";
            Column_DanhMuc.ReadOnly = true;
            // 
            // Column_Gia
            // 
            Column_Gia.HeaderText = "Giá Tiền";
            Column_Gia.Name = "Column_Gia";
            Column_Gia.ReadOnly = true;
            // 
            // Column_SoLuong
            // 
            Column_SoLuong.HeaderText = "Số Lượng Tồn";
            Column_SoLuong.Name = "Column_SoLuong";
            Column_SoLuong.ReadOnly = true;
            // 
            // Column_Delete
            // 
            Column_Delete.HeaderText = "Xóa";
            Column_Delete.Name = "Column_Delete";
            Column_Delete.ReadOnly = true;
            Column_Delete.Text = "Xóa";
            Column_Delete.UseColumnTextForButtonValue = true;
            // 
            // panelMain
            // 
            ...
            panelMain.Size = new Size(1222, 686);
        ...
        private DataGridViewTextBoxColumn Column_Ten;
        private DataGridViewTextBoxColumn Column_DanhMuc;
        private DataGridViewTextBoxColumn Column_Gia;
        private DataGridViewTextBoxColumn Column_SoLuong;
        private DataGridViewButtonColumn Column_Delete;
